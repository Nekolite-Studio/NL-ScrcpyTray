...
import { Smartphone, Settings, Play, Power, GripVertical, Monitor, Gauge, Zap, Wifi } from 'lucide-react';
...
export const DeviceListItem = ({ 
    ...
    const activeProfile = (device.status === 'Wifi' && device.settings.separateSettings) ? device.settings.wifiProfile : device.settings.usbProfile;
